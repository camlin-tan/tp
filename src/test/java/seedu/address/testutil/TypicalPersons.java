...
public class TypicalPersons {
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            ...
            .withBloodType("O").withAlcoholicRecord("Social drinker").withGender("M").withSmokingRecord("no").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withIdentityNumber("I6244").withEmail("hans@example.com").withAddress("chicago ave").withBloodType("O")
            .withAlcoholicRecord("Never").withGender("M").withSmokingRecord("yes").build();
