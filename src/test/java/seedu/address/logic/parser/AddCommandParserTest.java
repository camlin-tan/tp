...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        ...
                        + SMOKING_RECORD_DESC_NO + validExpectedPersonString,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + DATE_OF_BIRTH_DESC_AMY + BLOOD_TYPE_DESC + ALCOHOLIC_RECORD_DESC_AMY + GENDER_DESC_AMY
                + SMOKING_RECORD_DESC_NO, new AddCommand(expectedPerson));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(
                ...
                + DATE_OF_BIRTH_DESC_BOB + BLOOD_TYPE_DESC + ALCOHOLIC_RECORD_DESC_BOB
                + GENDER_DESC_BOB + SMOKING_RECORD_DESC_YES,
                Name.MESSAGE_CONSTRAINTS
        );
